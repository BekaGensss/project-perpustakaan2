...
class AuthController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        // Temukan pengguna untuk memvalidasi status dan role sebelum attempt
        ...
        if ($user) {
            ...
            if (Auth::attempt($credentials)) {
                ...
                // Arahkan ke dashboard admin jika role bukan member (misalnya role_id 1 untuk Admin)
                if ($user->role_id != 2) {
                    return redirect()->intended('admin/dashboard');
                }
                
                // Jika role adalah member (role_id 2), arahkan ke halaman utama/katalog
    ...
    /**
     * Menangani permintaan pendaftaran anggota (member) baru.
     *
    ...
    public function registerMember(Request $request)
    {
        ...
        User::create([
            ...
            'role_id' => 2, // Asumsi 2 adalah role ID untuk Member
            'is_active' => 1, // Anggota baru diaktifkan secara default
        ]);
    ...
    /**
     * Menangani permintaan login khusus anggota (member).
     *
     * @param Request $request
    ...
    public function loginMember(Request $request)
    {
        ...
        // Temukan pengguna berdasarkan email untuk validasi role dan status
        $user = User::where('email', $credentials['email'])->first();
        ...
        if ($user) {
            ...
            // Periksa apakah pengguna adalah member (asumsi role_id 2)
            if ($user->role_id != 2) {
